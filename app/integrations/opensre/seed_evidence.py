...
def merge_opensre_seed_into_state(
    ...
    evidence.update(_map_grafana_metrics(query_grafana_metrics(
        metric_name="",
        service_name=None,
        grafana_backend=backend,
    )))
    evidence.update(_map_grafana_logs(query_grafana_logs(
        service_name="",
        pipeline_name="",
    ...
    evidence.update(_map_grafana_traces(query_grafana_traces(
        service_name="",
        execution_run_id=None,
        limit=50,
        grafana_endpoint=None,
